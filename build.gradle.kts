...
val starterVersion: String = "252.28539.54"
...
dependencies {
    ...
    testImplementation("com.jetbrains.intellij.tools:ide-metrics-collector:${starterVersion}")
    testImplementation("com.jetbrains.intellij.tools:ide-metrics-collector-starter:${starterVersion}")
    testImplementation("com.jetbrains.intellij.tools:ide-performance-testing-commands:${starterVersion}")
